...
This folder contains Tcl scripts that build Libero SoC v12.5 design projects for the SmartFusion2 Security Evaluation Kit. These scripts are executed in Libero SoC to generate the sample designs. All cores boot from memory at 0x8000_0000.

#### SF2_Eval_Kit_TS_MiV_RV32IMA_BaseDesign
...
#### SF2_Eval_Kit_TS_MiV_RV32IMAF_BaseDesign
...
#### SF2_Eval_Kit_TS_MiV_RV32IMC_BaseDesign
